        ...
        <div class="body">
            ...
            <div class="register">
                <form action="">
                    ...
                    <label for="confirm-password">Құпия сөзді қайталаңыз</label>
                    <div class="secret">
                        <input type="password" class="form-control cst_inp" id="confirm-password" name="confirm-password" placeholder="************">
                        <button type="button" class="btn eye password"></button>
                    </div>
