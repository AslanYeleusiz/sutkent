...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="m-0">{{$typeName}} енгізу</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{$typeName}} енгізу</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">{{$typeName}} формасын енгізіңіз</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    @if (count($errors) > 0)
    ...
    <form method="post" action="{{route($routeName.'.store')}}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kk_rank" class="form-control" id="kk_rank" placeholder="Қызметі..." required>
            </div>
            <div class="form-group">
                <label for="ru_rank">Қызметі (орысша) *</label>
                <input type="text" name="ru_rank" class="form-control" id="ru_rank" placeholder="Қызметі..." required>
            </div>
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="image">Суретті жүктеңіз...</label>
                    </div>
                </div>
            </div>
        </div>
