...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="m-0">Бейнероликті енгізу</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Бейнероликті енгізу</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Жаңа бейнероликті енгізіңіз</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    @if (count($errors) > 0)
    ...
    <form method="post" action="{{route('videos.store')}}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea type="text" name="kk_description" class="form-control" id="kk_description" placeholder="Сипаттамасын енгізіңіз..." rows="9" required></textarea>
            </div>
            <div class="form-group">
                <label for="ru_description">Сипаттамасын енгізіңіз (орысша)</label>
                <textarea type="text" name="ru_description" class="form-control" id="ru_description" placeholder="Сипаттамасын енгізіңіз..." rows="9" required></textarea>
            </div>
            <div class="form-group">
                <label for="link">Youtube сілтемесінің хэш кодын қойыңыз</label>
                <input type="text" name="link" class="form-control" id="link" placeholder="хэш кодын қойыңыз..." required>
                <p class="mt-2">
