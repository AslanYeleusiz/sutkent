...
class AkimshilikController extends Controller
{
    /**
    ...
    {
        $users = akimshilik::where('type',1)->orderBy('created_at','desc')->paginate(20);
        return view('admin.pages.kenes.index')->with([
            'users' => $users,
            'typeName' => 'Әкімшілік',
            'routeName' => 'akimshilik'
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('akimshilik.index')->with('message', 'Әкімшілік сәтті жүктелді!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('akimshilik.index')->with('message', 'Әкімшілік сәтті өзгертілді!');
    }
    ...
    public function destroy($id)
    {
        ...
        $user->delete();
        return redirect()->route('akimshilik.index')->with('message', 'Жазба сәтті жойылды!');
    }
}
